...
public class SqlMapClientTemplate extends JdbcAccessor implements SqlMapClientOperations {
	 ...
	 */
	@Deprecated
	public <T> List<T> executeWithListResult(SqlMapClientCallback<List<T>> action) throws DataAccessException {
	 ...
	 */
	@Deprecated
	public <K,V> Map<K,V> executeWithMapResult(SqlMapClientCallback<Map<K,V>> action) throws DataAccessException {
		return execute(action);
	}
