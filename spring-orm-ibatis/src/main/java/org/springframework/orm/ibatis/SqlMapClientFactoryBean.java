...
public class SqlMapClientFactoryBean implements FactoryBean<SqlMapClient>, InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		...
		try {
			...
			if (this.dataSource != null) {
				TransactionConfig transactionConfig = this.transactionConfigClass.newInstance();
	...
	protected void applyTransactionConfig(SqlMapClient sqlMapClient, TransactionConfig transactionConfig) {
		...
		com.ibatis.sqlmap.engine.impl.ExtendedSqlMapClient extendedClient = (com.ibatis.sqlmap.engine.impl.ExtendedSqlMapClient) sqlMapClient;
